# kd_tool/stages/cleanup/cleanup_stage.py (v4.6 - Schema 路径与 task_id 更新版)
# -*- coding: utf-8 -*-
...
from typing import List, Dict, Set # Set 已在原文件中
...
from ....schemas.dtos import FileRecordDTO, UserDecisionDTO # <-- [指令] 已更新 (来自中央 schemas, 已移除 task_id)
from ....schemas.enums import DecisionType, ProcessingStatus        # <-- [指令] 已更新 (来自中央 schemas)

# --- Stage 内部导入 ---
from .settings_models import CleanupStageSettings # <-- [指令] 已更新为本地导入
from .adapter_interface import FileSystemAdapterInterface
from .errors import CleanupError, FileOperationError # <-- [指令] 本地错误导入
