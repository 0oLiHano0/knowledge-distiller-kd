# kd_tool/stages/prefilter/errors.py (v4.1 - 对齐 KDToolError)
...
class CzkawkaExecutionError(PrefilterError):
    ...
    def __init__(self, command: str, return_code: int, error_output: str):
        ...
        # 【v4.x 修改】使用关键字参数传递上下文，而非 'details' 字典。
        # KDToolError 会将这些关键字参数收集到 self.context_info 字典中。
        super().__init__(
            message=message, 
            command=command, 
