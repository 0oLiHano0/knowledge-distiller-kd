# kd_tool/core/orchestrator_factory.py (v4.1 - 签名更新版)
# -*- coding: utf-8 -*-
...
class OrchestratorFactory:
    ...
    def create(self,
               ...
               default_stage_order: List[str], # <-- [指令] 必须 包含此参数
        ...
        **返回**:
        ...
        try:
            orchestrator_instance = Orchestrator(
                ...
                default_stage_order=default_stage_order, # <-- [指令] 必须 传递
                settings=settings,
                logger=self._logger.bind(component="Orchestrator")
            )
